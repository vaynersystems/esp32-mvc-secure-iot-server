        ...
        var deviceModel = {
            ...
            Items:[
                ...
                },
                {
                    ...
                    'Value': device.type,
                    'Readonly': false,
                    'Data' : [{'name':'Digital Input', 'value': 1, 'group': 'Inputs'},{'name': 'Analog Input', 'value': 2, 'group': 'Inputs'},{ 'name': 'Thermometer', 'value':3, 'group': 'Inputs'}, {'name': 'Switch', 'value': 4, 'group': 'Outputs'},{'name':'Relay' , 'value': 1, 'group': 'Outputs'}]
                },
                {
                    'Name': 'Device Pin',
                    'Type': 'Lookup',
                    'Value': device.pin,
                    'Readonly': false,
                    'Data' : [{'name':'D22', 'value':22}, {'name': 'D23', 'value':23}]
                },
                {
                    'Name': 'MQTT Publish',
                    'Type': 'Boolean',
                    'Value': device.mqtt.publish,
                    'Readonly': false
                },
                {
                    'Name': 'Topic',
                    ...
                    'Value': 'getTemp',
                    'Readonly': false,
                    'Condition1': device.mqtt.publish,
                    'ConditionValue1': true,
                },
                {
                    'Name': 'Frequency',
                    'Type': 'Lookup',
                    'Value': device.mqtt.frequency,
                    'Readonly': false,
                    'Condition1': device.mqtt.publish,
                    'ConditionValue1': true,
