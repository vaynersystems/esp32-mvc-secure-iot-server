...
function loadSettings(configData){
    ...
    //overall
    var view = configData.preferences === undefined ? 'devices' : configData.preferences.lastPage;
    selectView(view);
    ...
    if(hostEnableSSLElement !== null) hostEnableSSLElement.checked = configData.server.enableSSL;
